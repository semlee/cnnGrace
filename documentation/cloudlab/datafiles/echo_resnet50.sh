...
echo "resnet50 input data"
echo "UNAME: $UNAME" >> resnet_echo.output
echo "SORT: $SORT" >> resnet_echo.output
echo "GREP: $GREP" >> resnet_echo.output
echo "CUT: $CUT" >> resnet_echo.output
echo "WC: $WC" >> resnet_echo.output
echo "CHECK_DNN_MB: $CHECK_DNN_MB" >> resnet_echo.output
echo "CHECK_DNN_ITERS: $CHECK_DNN_ITERS" >> resnet_echo.output
echo "MB: $MB" >> resnet_echo.output
echo "ITERS: $ITERS" >> resnet_echo.output
echo "NUMA: $NUMA" >> resnet_echo.output
echo "BIN: $BIN" >> resnet_echo.output
echo "TYPE: $TYPE" >> resnet_echo.output
echo "FORMAT: $FORMAT" >> resnet_echo.output
echo "PAD: $PAD" >> resnet_echo.output
echo "NS: $NS" >> resnet_echo.output
echo "NC: $NC" >> resnet_echo.output
echo "NT: $NT" >> resnet_echo.output
echo "HT: $HT" >> resnet_echo.output
echo "NN: $NN" >> resnet_echo.output
echo "CPUFLAGS: $CPUFLAGS"
echo "NUMACTL: $NUMACTL" >> resnet_echo.output
echo "OMP_NUM_THREADS: $OMP_NUM_THREADS" >> resnet_echo.output
echo "KMP_AFFINITY: $KMP_AFFINITY" >> resnet_echo.output
echo "KMP_HW_SUBSET: $KMP_HW_SUBSET" >> resnet_echo.output
echo "LIBXSMM_TARGET_HIDDEN: $LIBXSMM_TARGET_HIDDEN"
